...
doc_start :-
    write('This is DocBot+. It is a simple chatbot that will converse with you'),
    nl,
    write('The bot is not a personal assistant, rather just a companion'),
    nl,
    write('You can talk about your feelings, day, or ask some questions'),
    nl,
    write('type in <hi_docbot.> in the prompt. To end your session simply type <bye>. Enjoy!').
hi_docbot :-
    nl,
    nl,
    write('Hi, my name is DocBot+. How are you?'),
    nl,
    nl,
    readline(Input),
    nl,
...
pattern([perhaps, _|_], ['Why the uncertain tone?']).[- home/ragehelix/Documents/TY_Sem5/AI_L/AI_OpenEnded_ChatBot/docbot_main.pl'].
...
pattern([1], ['I','am', 'not', 'sure', 'Please', continue, '.']).
